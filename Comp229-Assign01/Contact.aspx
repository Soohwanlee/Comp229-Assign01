...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
        ...
        <address>
            ...
            SNS :
            <br />
            <!-- I didn't use my real sns address -->
            <div style="align-content: center">
                <a href="https://www.linkedin.com">
                    <img class="img-rounded" src="../Assets/images/linkedin.png" width="100" height="100"></a>
                <a href="https://www.facebook.com/">
                    <img src="../Assets/images/facebook.png" width="100" height="100"></a>
                <a href="https://www.instagram.com">
                    <img class="img-rounded" src="../Assets/images/insta.png" width="100" height="100"></a>
            </div>
        </div>
        <div class="col-md-8">
